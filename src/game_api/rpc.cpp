...
void extinguish_particles(ParticleEmitterInfo* particle_emitter)
{
    ...
    if (offset != 0)
    {
        ...
        {
            if (particle_emitter->emitted_particle_infos_type2.unknown4 != 0)
            {
                fpf((ParticleEmitterInfo*)particle_emitter->emitted_particle_infos_type2.unknown4);
            }
            if (particle_emitter->emitted_particle_infos_type1.unknown4 != 0)
            {
                fpf((ParticleEmitterInfo*)particle_emitter->emitted_particle_infos_type1.unknown4);
            }
